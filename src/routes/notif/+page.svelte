<script lang="ts">
	...
	async function getRepoName(id: string) {
		let { data }: any = await octokit.request('GET /repositories/{idNumb}', {
			idNumb: id,
			headers: {}
		});
...
<div class="jumbotron">
	...
	<p class="lead fs-1" style="color: white;">
		Choose which day of the week and how often you want to receive email notifications.
	</p>
